...
class iTransformerEmbedder(nn.Module):
    """
    Paper link: https://arxiv.org/abs/2310.06625
    """

    def __init__(self, configs):
        super(iTransformerEmbedder, self).__init__()
        seq_len = configs.seq_len
        pred_len = configs.pred_len
        d_model = configs.itran_d_model
        d_ff = configs.itran_d_ff
        n_heads = configs.itran_nheads
        e_layers = configs.itran_e_layers
